...
$app->get("/checkout", function(){
	...
	if (!$address->getdesnumber()) $address->getdesnumber('');
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Pet Shop";
	$dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
	$dadosboleto["demonstrativo3"] = "";
	$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
	$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: jordylucas_1@hotmail.com";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Pet Shop E-commerce";
...
$app->post("/profile/change-password",function(){
	...
	if ($_POST['new_pass_confirm'] != $_POST['new_pass']) {
		...
		User::setError("A senhas não batem.");
		header("Location: /profile/change-password");
		exit;
	}
